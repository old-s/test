...
public class AuctionListActivity extends BaseMvpActivity<AuctionPresenter> implements ILoadView {
    ...
    @OnClick({R.id.img_back, R.id.layout_brand, R.id.layout_type, R.id.txt_auction})
    ...
    private void showBrandDialog(final ArrayList<FlowObject> data, final String type) {
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_brand, null);
        ...
        final FlowAdapter flowAdapter = new FlowAdapter(this, data);
