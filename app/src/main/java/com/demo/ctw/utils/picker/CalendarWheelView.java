 ...
 */
public class CalendarWheelView extends ScrollView {
    /**
     ...
     */
    public static final int TEXT_COLOR_FOCUS = 0XFFa7bb2c;
    /**
    ...
    public static final int LINE_COLOR = 0XFFa7bb2c;
    /**
    ...
    private List<AddressPicker.Area> items = new ArrayList<>();
    ...
    private void initData() {
        ...
        for (AddressPicker.Area item : items) {
    ...
    private TextView createView(AddressPicker.Area item) {
...
//            Logger.i("viewWidth ---- " + viewWidth);
    ...
    private void _setItems(List<AddressPicker.Area> list) {
        items.clear();
        items.addAll(list);

        // 前面和后面补全
        for (int i = 0; i < offset; i++) {
            items.add(0,getEmptyArea());
            items.add(getEmptyArea());
        }

        initData();
    }
    private void _setItemsProvince(List<AddressPicker.Province> list) {
        items.clear();
        items.addAll(list);
    ...
    private void _setItemsCity(List<AddressPicker.City> list) {
        items.clear();
        items.addAll(list);
    ...
    private AddressPicker.County getEmptyArea(){
...
//    }
     ...
     */
    public void setItems(ArrayList<AddressPicker.Area> list, int index) {
        _setItems(list);
     ...
     * @param index the index
     */
    public void setItemsCity(ArrayList<AddressPicker.City> list, int index) {
        _setItemsCity(list);
        setSelectedIndex(index);
    }
    /**
     ...
     * @param index the index
     */
    public void setItemsProvince(ArrayList<AddressPicker.Province> list, int index) {
        _setItemsProvince(list);
        setSelectedIndex(index);
    }
    /**
     * Sets items.
     ...
     * @param item the item
     */
    public void setItems(List<AddressPicker.Area> list, String item) {
        _setItems(list);
     ...
     */
    public AddressPicker.Area getSelectedItem() {
    ...
    public interface OnWheelViewListener {
         ...
         * @param item          the item
         */
        void onSelected(boolean isUserScroll, int selectedIndex, AddressPicker.Area item);
    }
