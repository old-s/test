...
/**
 * Created by castorflex on 18/9/5
 */
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int color = a.getColor(R.styleable.CircularProgressBar_cpb_color, res.getColor(R.color.app));
        final float strokeWidth = a.getDimension(R.styleable.CircularProgressBar_cpb_stroke_width, res.getDimension(R.dimen.dimen_4));
        final float sweepSpeed = a.getFloat(R.styleable.CircularProgressBar_cpb_sweep_speed, 1);
        final float rotationSpeed = a.getFloat(R.styleable.CircularProgressBar_cpb_rotation_speed, 1);
